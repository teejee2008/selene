...
generic_depends=(mediainfo libav-tools vorbis-tools x264 lame mkvtoolnix realpath rsync)
debian_depends=(realpath mediainfo libav-tools vorbis-tools x264 lame mkvtoolnix rsync)
redhat_depends=(rsync mediainfo vorbis-tools mkvtoolnix)
arch_depends=(rsync mediainfo x264 ffmpeg vorbis-tools lame mkvtoolnix boost icu extra/libstdc++5)
